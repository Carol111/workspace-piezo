...
cprequire_test(["inline:com-chilipeppr-workspace-piezo"], function(ws) {
    ...
    $('title').html("Piezo Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-piezo", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-piezo", // Make the id the same as the cpdefine id
        name: "Workspace / Piezo", // The descriptive name of your widget.
        desc: `A sample ChiliPeppr Workspace for a Piezo Sensor project`,
