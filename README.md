...
| Description           | A ChiliPeppr Workspace Piezo. |
  ...
  function() {
    ...
    cprequire(
      ...
      function(myWorkspacePiezo) {
        ...
        console.log("Workspace / Sample just got loaded.", myWorkspacePiezo);
