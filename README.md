# com-chilipeppr-workspace-piezo
A sample ChiliPeppr Workspace for a Piezo Sensor project

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / Piezo
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-piezo |
| Name                  | Workspace / Piezo |
| Description           | A sample ChiliPeppr Workspace for a Piezo Sensor project |
| chilipeppr.load() URL | http://raw.githubusercontent.com/Carol111/workspace-piezo/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/ccm111/piezo |
| Github URL            | http://github.com/Carol111/workspace-piezo |
| Test URL              | https://preview.c9users.io/ccm111/piezo/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/Carol111/workspace-piezo/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-piezo"], // the id you gave your workspace
      function(myWorkspacePiezo) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Piezo just got loaded.", myWorkspacePiezo);
        myWorkspacePiezo.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-piezo"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Piezo"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A sample ChiliPeppr Workspace for a Piezo Sensor project"</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/Carol111/workspace-piezo/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/ccm111/piezo"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/Carol111/workspace-piezo"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://piezo-ccm111.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
